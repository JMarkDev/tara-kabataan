...
const ContactUs = () => {
  ...
  return (
    <div className="lg:px-20">
      <h1 className="text-center text-2xl lg:text-4xl p-10 font-bold">
      ...
      <div className="flex md:flex-row flex-col justify-center bg-white lg:p-10 p-5">
        ...
        >
          ...
          <form action="" ref={form} onSubmit={sendEmail}>
            ...
            <button
              type="submit"
              className="rounded-full p-2 px-3 md:px-5 bg-indigo-500 hover:bg-indigo-800 text-white text-sm lg:text-md mt-5"
            >
              Send Message
            </button>
          </form>
