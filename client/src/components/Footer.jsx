              ...
              <div className="flex relative gap-4 pt-5 text-blue-gray-900 ">
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M22.206 6.497c-.27-1.013-1.015-1.808-2.027-2.08C18.405 4 12 4 12 4s-6.405 0-8.178.418c-1.012.272-1.757 1.067-2.027 2.08C1.42 8.27 1.227 10.183 1.181 12c.046 1.817.239 3.73.611 5.503.27 1.013 1.015 1.808 2.027 2.08C5.595 20 12 20 12 20s6.405 0 8.178-.418c1.012-.272 1.757-1.067 2.027-2.08.372-1.773.565-3.686.611-5.503-.046-1.817-.239-3.73-.611-5.503zM9.5 15.5V8.5l6 3-6 3z"
                      clipRule="evenodd"
                    />
                  </svg>
                </Typography>
