                ...
                (
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{event_category}</td>
                      <td className="px-6 py-4">{event_type}</td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        {location}
                      </td>
                      <td className="px-6 py-4">
                        <span
                          className={`px-2 py-2 font-normal leading-tight ${
                            status === "Completed"
                              ? "text-green-700  green-blue-700 bg-green-100 rounded-full green:bg-blue-700 "
                              : " text-blue-700 bg-blue-100 rounded-full  dark:text-blue-100"
                          }rounded-full`}
                        >
                          {status}
                        </span>
